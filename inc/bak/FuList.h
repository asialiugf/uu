...
static const std::map<std::string,int> M_DCE_T = {
  {"a",  2  },//   豆一
  {"b",  2  },//   豆二
  {"bb", 0  },//   胶合板
  {"c",  0  },//   玉米
...
static const std::map<std::string,int> M_SHFE_T = {
  {"cu", 3 }, //   铜
  {"al", 3 }, //   铝
  {"zn", 3 }, //   锌
  {"pb", 3 }, //   铅
...
static const std::map<std::string,int> M_CFFE_T = {
  {"IF",  5 }, // 沪深300
  {"IC",  5 }, // 中证500
  {"IH",  5 }, // 上证50
  {"TF",  6 }, // 国债5年期
